        ...
        var a = e("../common/PlayerInfo"),
            ...
            m = function (e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function () {
                    ...
                    var random_f = Math.floor(Math.random() * (4 + 1 - 0)) + 0
            ...
            p = function (e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function () {
                    ...
                    if (i.default.playerTouch && null != a.default.Instance.targetFruit) {
                        console.log(cheat)
                        console.log(a)
                        console.log(a.default.Instance.targetFruit)
                        a.default.Instance.targetFruit.scaleX = 1
                        a.default.Instance.targetFruit.scaleY = 1
                        this.touchNum = 1;
                    ...
                    i.default.playerTouch && null != a.default.Instance.targetFruit && 1 == this.touchNum && (this.touchNum = 0, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).radius = a.default.Instance.targetFruit.height / 2, a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).apply(), a.default.Instance.targetFruit.getComponent(cc.RigidBody).type = cc.RigidBodyType.Dynamic, a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, -800), a.default.Instance.targetFruit = null, this.scheduleOnce(function () {
                        if (cheat == 0) {
                            ...
                            console.log(cheat-1)
                            i.default.GameUpdateCtrl && a.default.Instance.createOneFruit(cheat-1), t.createFruitCount++
                        }
                        //cheat = 0
                        //i.default.GameUpdateCtrl && a.default.Instance.createOneFruit(Math.floor( Math.random() * (4) ) + 5),t.createFruitCount++
                        // var random_f = Math.floor( Math.random() * (4 + 1 - 0) ) + 0 ;
                        // i.default.GameUpdateCtrl && a.default.Instance.createOneFruit(random_f), t.createFruitCount++
                    }, .5))
        ...
        cc.Class({
            ...
            gameEnd1: function () {
                ...
                function TweetButtonAction() {
                    var twiTxt = `https://twitter.com/share?hashtags=スイカのゲーム&url=https://suika-game.app&text=現在プレイ中のスイカのゲームの記録は${e.sceneScore.string}点です。`
                    window.open(twiTxt);
                }
        ...
        var a = e("../common/PlayerInfo"),
            ...
            h = function (e) {
                ...
                return o(t, e), n = t, t.prototype.onLoad = function () {
                    ...
                    const ip = GameMyScoreResult.dataset.ip
                    const hostUrl = location.hostname === "localhost" || location.hostname === "127.0.0.1" ? 'http://localhost:8000' : "/suika/project/"
                    const headers = {
                        'Content-type': 'Application/json',
                        'Accept': 'Application/json',
                    }
                    if (dataloadState == false) {
                        axios.get(hostUrl + '/my_scores/' + ip.split('.').join('_') + '.json', headers)
                            .then(response => {
                                ...
                                for (let item of suika_score) {
                                    ...
                                    if (suika_score_count > 3) {
                                        ...
                                        suika_score_text.push('<li class="list-ranking-item"><span class="rank_icon rank_' + suika_score_count + '">' + suika_score_count + '</span>' + '<img src="' + fruits_icon + '" />' + `${minutes}分${seconds}秒` + '</li>');
                                    }
                                    suika_score_count++;
                                }
