        ...
        cc.Class({
            ...
            gameEnd1: function() {
                ...
                function TweetButtonAction(){
                    var twiTxt = `https://twitter.com/share?hashtags=スイカゲーム&url=https://suika-game.app&text=現在プレイ中のスイカのゲームの記録は${e.sceneScore.string}点です。`
                    window.open(twiTxt);
                }
        ...
        var o = e("HttpManagerJs"),
            ...
            r = (e("GameUiTools"), {
                ...
                init: function(e, t, n) {
                    ...
                    a.launchScene = e, a.Bros = t, a.caS = n, this.curType = 1, this.getHttpGameId(), this.gamePV_load(), o.httpInitUrl(this.gameHttpId);
