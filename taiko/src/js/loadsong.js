        ...
        if (this.multiplayer) {
            ...
            pageEvents.add(p2, "message", event => {
                if (event.type === "gameload") {
                    ...
                    var drumGame1 = new Controller(song, this.songData, false, 1, this.touchEnabled)
                    var drumGame2 = new Controller(this.selectedSong2, this.song2Data, true, 2, this.touchEnabled)
                    drumGame1.run(drumGame2)
            ...
            this.clean()
            var drumGame = new Controller(song, this.songData, this.autoPlayEnabled, false, this.touchEnabled)
            drumGame.run()
        }
    }
